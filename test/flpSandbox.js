		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#luispracticaproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"luispracticaproject1-display": {
								"semanticObject": "luispracticaproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=luispractica.project1",
									"url": sap.ui.require.toUrl("luispractica/project1")
								}
							}
						}
					}
